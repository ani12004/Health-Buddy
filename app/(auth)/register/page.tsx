...
import { Shield, Mail, Lock, Eye, EyeOff, User, Quote } from 'lucide-react'
        ...
        try {
            const { data, error } = await supabase.auth.signUp({
                ...
                options: {
                    data: {
                        full_name: fullName,
                        // Role will be set during onboarding or defaulted to 'patient'
                        role: 'patient'
                    }
                }
            })
            ...
            if (data.session) {
                ...
                // Wait a bit to let the toast show, then redirect to login
            ...
            <div className="w-full md:w-7/12 lg:w-1/2 flex items-center justify-center p-6 md:p-12 lg:p-24 relative">
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="text-center md:text-left space-y-2">
                        <h1 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">Create Account</h1>
                        <p className="text-slate-500 dark:text-slate-400">Join thousands of patients and doctors today.</p>
                    </div>
